...
const HomePage = () => {
    return (
        <div className="home-container min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
            ...
            {/* Chatbot Section */}
            <div className="bg-white p-6 rounded-lg shadow-md max-w-xl w-full text-center mt-10">
                ...
                <div className="mt-6 text-center">
                    <p className="text-gray-400 text-sm">
                        ...
                        <a href="/faq" className="text-teal-500 hover:underline">FAQ</a> or{' '}
                        <a href="/contact" className="text-teal-500 hover:underline">contact us</a>.
                    </p>
                </div>
            </div>
